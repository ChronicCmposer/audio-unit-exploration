//
//  audio_unit_explorationExtensionDSPKernel.hpp
...
#import "audio_unit_explorationExtensionParameterAddresses.h"

/*
 audio_unit_explorationExtensionDSPKernel
 As a non-ObjC class, this is safe to use from render thread.
 */
class audio_unit_explorationExtensionDSPKernel {
public:
    ...
    void setParameter(AUParameterAddress address, AUValue value) {
        switch (address) {
            case audio_unit_explorationExtensionParameterAddress::gain:
                mGain = value;
                break;
                // Add a case for each parameter in audio_unit_explorationExtensionParameterAddresses.h
        }
    }
    ...
    void process(std::span<float const*> inputBuffers, std::span<float *> outputBuffers, AUEventSampleTime bufferStartTime, AUAudioFrameCount frameCount) {
        /*
         ...
         modify the check in [audio_unit_explorationExtensionAudioUnit allocateRenderResourcesAndReturnError]
         */
