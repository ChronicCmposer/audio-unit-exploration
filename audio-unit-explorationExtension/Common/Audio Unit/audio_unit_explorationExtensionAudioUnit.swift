//
//  audio_unit_explorationExtensionAudioUnit.swift
...
public class audio_unit_explorationExtensionAudioUnit: AUAudioUnit, @unchecked Sendable
{
	// C++ Objects
	var kernel = audio_unit_explorationExtensionDSPKernel()
