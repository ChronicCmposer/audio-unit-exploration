...
private let log = Logger(subsystem: "com.chroniccmposer.audio-unit-explorationExtension", category: "AudioUnitViewController")

@MainActor
public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<audio_unit_explorationExtensionMainView>?
	...
	*/
	...
	nonisolated public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
		return try DispatchQueue.main.sync {
			...
			audioUnit = try audio_unit_explorationExtensionAudioUnit(componentDescription: componentDescription, options: [])
			
			guard let audioUnit = self.audioUnit as? audio_unit_explorationExtensionAudioUnit else {
				log.error("Unable to create audio_unit_explorationExtensionAudioUnit")
				return audioUnit!
			}
			...
			audioUnit.setupParameterTree(audio_unit_explorationExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = audio_unit_explorationExtensionMainView(parameterTree: observableParameterTree)
