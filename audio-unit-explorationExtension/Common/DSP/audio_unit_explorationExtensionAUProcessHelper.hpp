//
//  audio_unit_explorationExtensionAUProcessHelper.hpp
...
#include <vector>
#include "audio_unit_explorationExtensionDSPKernel.hpp"
#include "audio_unit_explorationExtensionBufferedAudioBus.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(audio_unit_explorationExtensionDSPKernel& kernel, BufferedInputBus& bufferedInputBus)
    : mKernel{kernel},
...
private:
    audio_unit_explorationExtensionDSPKernel& mKernel;
